...
2. Push semua file dari folder `biodata` ke repository.
3. Buka `Settings` -> `Pages`.
4. Pilih branch `main` (atau `master`) dan root `/` sebagai sumbernya.
5. Simpan, lalu tunggu beberapa menit sampai situs aktif.
